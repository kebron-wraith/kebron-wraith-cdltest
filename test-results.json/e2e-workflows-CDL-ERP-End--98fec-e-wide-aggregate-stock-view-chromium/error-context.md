...
- Name: e2e-workflows.spec.js >> CDL ERP End-to-End Workflows >> Additional Feature Verification >> Site-wide aggregate stock view
- Location: tests\e2e-workflows.spec.js:514:5
