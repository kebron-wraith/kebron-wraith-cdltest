...
- Name: e2e-workflows.spec.js >> CDL ERP End-to-End Workflows >> Workflow 6: AI Advisor Access Control >> Store Manager/storekeeper CANNOT access AI (quota=0)
- Location: tests\e2e-workflows.spec.js:388:5
