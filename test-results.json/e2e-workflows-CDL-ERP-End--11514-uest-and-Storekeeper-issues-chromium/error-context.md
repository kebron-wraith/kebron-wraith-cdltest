...
- Name: e2e-workflows.spec.js >> CDL ERP End-to-End Workflows >> Workflow 1: Material Request Flow >> Project Manager approves request and Storekeeper issues
- Location: tests\e2e-workflows.spec.js:68:5
