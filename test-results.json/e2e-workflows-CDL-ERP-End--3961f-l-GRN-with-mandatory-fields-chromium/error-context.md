...
- Name: e2e-workflows.spec.js >> CDL ERP End-to-End Workflows >> Workflow 3: GRN Entry (Local Delivery) >> Storekeeper enters manual GRN with mandatory fields
- Location: tests\e2e-workflows.spec.js:184:5
